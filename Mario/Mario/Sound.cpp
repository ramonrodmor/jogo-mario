...
Sound::Sound(string fileName, uint nVoices)
{
	...
	voices = new IXAudio2SourceVoice*[voicesCount];
	...
	soundBuffer.Flags = XAUDIO2_END_OF_STREAM;	// este será o único buffer para a "Source Voice"

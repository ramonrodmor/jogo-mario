...
private:
	...
	static const uint MaxBatchSize = 2048;						// tamanho máximo do lote de sprites	
	...
	vector<SpriteInfo*> spriteVector;							// vetor de ponteiros para sprites
	SpriteInfo * spriteStorage;									// armazenamento de sprites
	uint storageIndex;											// número de sprites armazenados
	
	// renderiza um grupo de sprites de mesma textura
	void RenderBatch(ID3D11ShaderResourceView * texture, SpriteInfo ** sprites, uint count);
